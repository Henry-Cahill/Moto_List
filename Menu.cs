...
namespace Moto_List
{
   public class Menu
   {
    ...
    .ToDictionary(option => option, option => false);
      ...
      private async void HandleGearBag()
      {
         try
         {
            ...
            if (selectionState[MenuOption.GearBag])
            {
               ...
               await LogSelectionAsync("Gear Bag selected.");
            }
            else
            {
               Console.WriteLine("Gear Bag unselected.");
               await LogSelectionAsync("Gear Bag unselected.");
            }
         }
         catch (Exception ex)
         {
      ...
      private async void HandleGloves()
      {
         try
         {
      ...
      private async void HandleChestProtector()
      {
         try
         {
      ...
      private async void HandleNeckBrace()
      {
         try
         {
      ...
      private async void HandleHelmetBag()
      {
         try
         {
      ...
      private async void HandleHelmet()
      {
         try
         {
      ...
      private async void HandleGoggleBag()
      {
         try
         {
      ...
      private async void HandleGoggles()
      {
         try
         {
      ...
      private async void HandleGoggleReplacementLenses()
      {
         try
         {
      ...
      private async void HandleGoggleTearOffs()
      {
         try
         {
      ...
      private async void HandleGoggleRollOffs()
      {
         try
         {
      ...
      private async void HandleGoggleAccessories()
      {
         try
         {
      ...
      private async void HandleKneeGuards()
      {
         try
         {
      ...
      private async void HandleElbowGuards()
      {
         try
         {
      ...
      private async void HandleKidneyBelt()
      {
         try
         {
      ...
      private async void HandleRaceBoots()
      {
         try
         {
